                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush" id="tableData">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col" class="sort" data-sort="name">ID Mitra</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Blokir Mitra</h5>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="alert alert-warning" role="alert">
                          Apakah Anda yakin ingin melakukan blokir terhadap mitra ini ?
                        </div>
                        
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal">Blokir</button>
                </div>
            </div>
        </div>
    </div>
                ...
                if (response['status']=='failed') {
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            "<td><a href='#' class='table-action' data-toggle='tooltip' title='Info User'><i class='fas fa-info-circle'></i></a> <a href='#' class='table-action' data-toggle='tooltip' title='Blokir User'><i class='fa fa-ban' data-toggle='modal' data-target='#exampleModalCenter'></i></a></td>" +
                            "</tr>";
