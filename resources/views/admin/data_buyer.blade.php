        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="{!!('add_buyer')!!}" class="btn btn-sm btn-neutral">Tambah Data</a>
                </div>
            </div>
            <!-- Card stats -->
        </div>
                ...
                if (response['status']=='failed') {
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            "<td>" + response['data'][i].nama_pic + "</td>" +
                            "<td>" + response['data'][i].phone_pic + "</td>" +
                            "<td>Jakarta</td>" +
                            "<td><span style='background-color:"+color+";border-radius:8px;padding:5px;color:#fff'>"+status+"</span></td>" +
                            "<td><a href='edit_buyer/"+response['data'][i]._id+"' class='table-action' data-toggle='tooltip' title='Edit Hub'><i class='fas fa-edit'></i></a>"+resend+"</td>" +
                            "</tr>";
