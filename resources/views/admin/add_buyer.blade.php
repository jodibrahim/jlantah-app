            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Tambah Data Buyer  </h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form id="addData">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Nama Buyer" required />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-control-label" for="validationCustom02">Kode Buyer</label>
                                    <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan Kode Buyer" required />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-control-label" for="validationCustom03">Nama PIC</label>
                                    <input type="text" class="form-control" id="nama_pic" name="nama_pic" placeholder="Masukkan PIC/Penanggungjawab" required />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-control-label" for="validationCustom04">Telepon</label>
                                    <input type="text" class="form-control" id="phone_pic" name="phone_pic" placeholder="Masukkan Telepon" required />
                                </div>
                            </div>
                            <div class="form-row">
