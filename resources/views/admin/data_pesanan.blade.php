...
<div class="container-fluid mt--6">
    ...
    function loadData(limit, page){
        $.ajax({
            url: 'loadDataPesanan/'+limit+'/'+page,
            type: 'get',
            dataType: 'json',
            ...
            success: function(response){
                ...
                if (response['status']=='failed') {
                    ...
                    len = response['data']['orders'].length;
                    pag = response['data']['total_page'];
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            var content = "<tr>" +
                            "<td>" + response['data']['orders'][i].order_no + "</td>" +
                            "<td>" + response['data']['orders'][i].user.nama + "</td>" +
                            "<td>" + response['data']['orders'][i].jumlah_liter + "</td>" +
                            "<td>" + response['data']['orders'][i].alamat + "</td>" +
                            "<td><span style='background-color:#97e19d;border-radius:8px;padding:5px;color:#fff'>"+ response['data']['orders'][i].status +"</span></td>" +
                            "<td><a href='detail_pesanan/"+response['data']['orders'][i].id+"' class='table-action' data-toggle='tooltip' title='Info User'><i class='fas fa-info-circle'></i></a></td>" +
                            "</tr>";
