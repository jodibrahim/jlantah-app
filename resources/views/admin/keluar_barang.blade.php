        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="{!!('add_keluar_barang')!!}" class="btn btn-sm btn-neutral">Tambah Data</a>
                </div>
            </div>
            <!-- Card stats -->
        </div>
                    ...
                    <table class="table align-items-center table-flush" id="tableData">
                        <thead class="thead-light">
                          <tr>
                            ...
                            <th scope="col" class="sort" data-sort="budget">Pool</th>
                            <th scope="col" class="sort" data-sort="budget">Buyer</th>
                            <th scope="col" class="sort" data-sort="status">Driver</th>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="alert alert-warning" role="alert">
                          Apakah Anda yakin ingin melakukan verifikasi terhadap data ini ?
                        </div>
                ...
                if (response['status']=='failed') {
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            "<td>" + response['data'][i].hub['0'].nama + "</td>" +
                            "<td>" + response['data'][i].buyer['0'].nama + "</td>" +
                            ...
                            "<td><a href='#' class='table-action' data-toggle='tooltip' title='Edit Hub'><i class='fas fa-edit'></i></a></td>" +
                            "</tr>";
